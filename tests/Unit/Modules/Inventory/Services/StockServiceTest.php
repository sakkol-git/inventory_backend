...
class StockServiceTest extends TestCase
{
    ...
    {
        $result = $this->stockService->consume($this->stock, 10);
    ...
    public function test_consume_throws_exception_if_insufficient_stock(): void
    {
        ...
        $this->stockService->consume($this->stock, 90); // Only 80 available
    }
    ...
    public function test_consume_all_available_stock_changes_status_to_reserved(): void
    {
        ...
        $result = $this->stockService->consume($this->stock, 80);
    ...
    {
        $result = $this->stockService->reserve($this->stock, 30);
    ...
    public function test_reserve_throws_exception_if_insufficient_stock(): void
    {
        ...
        $this->stockService->reserve($this->stock, 90); // Only 80 available
    }

    public function test_release_decreases_reserved_quantity(): void
    {
        $result = $this->stockService->release($this->stock, 10);
    ...
    {
        $result = $this->stockService->release($this->stock, 50); // Trying to release more than 20
    ...
    public function test_restock_increases_quantity_and_syncs_status(): void
    {
        ...
        $result = $this->stockService->restock($outOfStock, 50);
