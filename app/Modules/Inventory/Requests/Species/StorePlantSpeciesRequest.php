...
class StorePlantSpeciesRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'scientific_name' => [
                ...
                Rule::unique('plant_species', 'scientific_name')->whereNull('deleted_at'),
            ],
            'family' => ['nullable', 'string', 'max:255'],
            'growth_type' => ['required', Rule::enum(PlantGrowthType::class)],
